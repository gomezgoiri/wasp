...
type NetworkProvider interface {
	...
	Attach(peeringID *PeeringID, receiver byte, callback func(recv *PeerMessageIn)) func()
}
...
type GroupProvider interface {
	...
	Attach(receiver byte, callback func(recv *PeerMessageGroupIn)) func()
...
type PeerDomainProvider interface {
	...
	Attach(receiver byte, callback func(recv *PeerMessageIn)) func()
